# TFG
El primer TFG está compuesto por
# TFG2
El segundo TFG presenta el script llamado app.py. Se trata de un programa en python desarrollado para actuar como una aplicación de escritorio.
